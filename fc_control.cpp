...
/*===========================commend definition==============================*/
	unsigned char cmd_on[6] = {0x11,0x06,0x00,0x01,0x00,0x00};	// open machine
	unsigned char cmd_off[6] = {0x11,0x06,0x00,0x01,0x00,0x01};	// close machine
	unsigned char cmd_get_v[6] = {0x11,0x03,0x01,0x01,0x00,0x01};
	unsigned char cmd_get_i[6] = {0x11,0x03,0x01,0x03,0x00,0x01};
	unsigned char cmd_get_status[6] = {0x11,0x03,0x01,0x07,0x00,0x01}; // *won't use
