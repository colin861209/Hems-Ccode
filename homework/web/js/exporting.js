    ...
    function (g) { "object" === typeof module && module.exports ? module.exports = g : "function" === typeof define && define.amd ? define(function () { return g }) : g(Highcharts) })(function (g) {
        (function (f) {
            var g = f.defaultOptions, y = f.doc, z = f.Chart, q = f.addEvent, H = f.removeEvent, B = f.fireEvent, r = f.createElement, C = f.discardElement, u = f.css, p = f.merge, A = f.pick, l = f.each, E = f.objectEach, t = f.extend, I = f.isTouchDevice, D = f.win, F = D.navigator.userAgent, J = f.Renderer.prototype.symbols; /Edge\/|Trident\/|MSIE /.test(F); /firefox/i.test(F); t(g.lang,
                { printChart: "Print chart", Customize: "更改标题", downloadPNG: "Download PNG image", downloadJPEG: "Download JPEG image", downloadPDF: "Download PDF document", downloadSVG: "Download SVG vector image", contextButtonTitle: "Chart context menu" }); g.navigation = { buttonOptions: { theme: {}, symbolSize: 14, symbolX: 12.5, symbolY: 10.5, align: "right", buttonSpacing: 3, height: 22, verticalAlign: "top", width: 24 } }; p(!0, g.navigation, {
                    menuStyle: { border: "1px solid #999999", background: "#ffffff", padding: "5px 0" }, menuItemStyle: {
                        padding: "0.5em 1em", background: "none",
                        color: "#330633", fontSize: I ? "14px" : "11px", transition: "background 250ms, color 250ms"
                    ...
                    type: "image/png", url: "https://export.highcharts.com/", printMaxWidth: 780, scale: 2, buttons: {
                        contextButton: {
                            ...
                            menuItems: "printChart Customize separator downloadPNG downloadJPEG downloadPDF downloadSVG".split(" ")
                        }
                    }, menuItemDefinitions: {
                        printChart: { textKeys: "printChart", onclick: function () { this.print() } }, Customize: { textKeys: "Customize", onclick: function () {prompt("input ur name","yy") } }, separator: { separator: !0 }, downloadPNG: { textKeys: "downloadPNG", onclick: function () { this.exportChart() } }, downloadJPEG: { textKeys: "downloadJPEG", onclick: function () { this.exportChart({ type: "image/jpeg" }) } }, downloadPDF: { textKeys: "downloadPDF", onclick: function () { this.exportChart({ type: "application/pdf" }) } }, downloadSVG: {
                            textKeys: "downloadSVG",
